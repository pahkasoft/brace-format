    ...
    return {
        ...
        output: {
            ...
            library: {
                ...
                name: libraryType === "umd" ? "BraceFormat" : undefined,
                type: libraryType,
        ...
        plugins: [
            new webpack.BannerPlugin({
                banner: `BraceFormat v${packageJson.version} | (c) 2025 PahkaSoft | Licensed under the MIT License | Includes JSBI (Apache License 2.0)`
            }),
