...
describe("Testing BraceFormat", () => {
    ...
    it("wider unicode symbols", () => {
        ...
        // Skin tone, ZWJ
        expect(format("{:.3s}", "👍👍👍👍👍")).toEqual("👍👍👍"); // U+1F44D
        expect(format("{:.3s}", "👍🏽👍🏽👍🏽👍🏽👍🏽")).toEqual("👍🏽👍🏽👍🏽"); // U+1F44D + U+1F3FD (thumbs up + skin tone)
        expect(format("{:.3s}", "👨‍👩‍👧‍👦👨‍👩‍👧‍👦👨‍👩‍👧‍👦👨‍👩‍👧‍👦👨‍👩‍👧‍👦")).toEqual("👨‍👩‍👧‍👦👨‍👩‍👧‍👦👨‍👩‍👧‍👦"); // U+1F468 + ZWJ + U+1F469 + ZWJ + U+1F467 + ZWJ + U+1F466
        expect(format("{:.3s}", "🧑🏽‍⚕️🧑🏽‍⚕️🧑🏽‍⚕️🧑🏽‍⚕️🧑🏽‍⚕️")).toEqual("🧑🏽‍⚕️🧑🏽‍⚕️🧑🏽‍⚕️"); // 
    });
